...
import { Zap, ArrowLeft, ArrowRight, Loader2, Lock, Mail, AlertCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#FCFCFA] flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="bg-white border-2 border-[#3A4118] rounded-[2.5rem] p-10 shadow-[10px_10px_0px_0px_rgba(58,65,24,1)]">
          <div className="mb-8">
            <h1 className="text-3xl font-black text-[#3A4118] uppercase tracking-tighter italic">Credentials<span className="text-[#A3B18A] not-italic">.</span></h1>
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Manual override access</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-2">
                ...
                <Link href="/forgot-password" className="text-[10px] font-black text-tactical-sage uppercase hover:underline">Forgot?</Link>
              </div>
              <div className="relative">
        ...
        <p className="text-center mt-8 text-[10px] font-black text-slate-400 uppercase tracking-widest">
          New to the circle? <Link href="/register" className="text-[#3A4118] underline">Join now</Link>
        </p>
      </div>
    </div>
  );
